...
void Player::setting_board() {
	...
	while (1) {
		...
		else if ((direction == 'h' && (p1.y + 4 > 7)) || (direction == 'v' && (p1.x + 4 > 7)))
		{
	...
	while (1) {
		...
		else if ((direction == 'h' && (p2.y + 3 > 7)) || (direction == 'v' && (p2.x + 3 > 7)))
		{
			std::cout << "Your input was out of bounds! Try again!" << std::endl;
		}
...
//
	...
	while (1) {
		...
		else if ((direction == 'h' && (p3.y + 2 > 7)) || (direction == 'v' && (p3.x + 2 > 7)))
		{
			std::cout << "Your input was out of bounds! Try again!" << std::endl;
		}
	...
	while (1) {
		...
		else if ((direction == 'h' && (p4.y + 2 > 7)) || (direction == 'v' && (p4.x + 2 > 7)))
		{
			std::cout << "Your input was out of bounds! Try again!" << std::endl;
		}
	...
	while (1) {
		...
		else if ((direction == 'h' && (p5.y + 1 > 7)) || (direction == 'v' && (p5.x + 1 > 7)))
		{
			std::cout << "Your input was out of bounds! Try again!" << std::endl;
		}
